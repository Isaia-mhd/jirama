...
@section('content')
    <div class="w-full mb-[100px]">
        ...
        {{-- Field --}}
        <form action="{{ route("releve.update", $eauReleve->id) }}" method="post"
            ...
            <div class="w-full flex gap-4">
                ...
                <div class="flex flex-col gap-1 w-full">
                    ...
                    <input class="bg-slate-900 text-white border-[1px] border-gray-500 py-2 px-2 outline-2 focus:outline focus:outline-blue-700"
                        type="int" min="1" name="valeur" id="val" placeholder="Valeur en m3" value="{{ $eauReleve->valeur }}">
                    @error('valeur')
                ...
                <div class="flex flex-col gap-1 w-full">
                    ...
                    <input type="date" name="date_releve" id="date_rel" class="bg-slate-900 text-white font-semibold" value="{{ $eauReleve->date_releve }}">
            ...
            <div class="w-full flex gap-4">
                ...
                <div class="flex flex-col gap-1 w-full">
                    ...
                    <input type="date" name="date_presentation" id="date_pre"
                        class="bg-slate-900 text-white font-semibold" value="{{ $eauReleve->date_presentation }}">
                ...
                <div class="flex flex-col gap-1 w-full">
                    ...
                    <input type="date" name="date_limite" id="date_lim" class="bg-slate-900 text-white font-semibold" value="{{ $eauReleve->date_limite }}">
